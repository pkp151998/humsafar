      ...
      <nav className="bg-white/80 backdrop-blur border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex justify-between items-center">
          ...
          <button
            ...
            className="text-sm font-medium px-4 py-2 rounded-full border border-slate-200 text-slate-700 hover:border-rose-500 hover:text-rose-600 hover:shadow-sm transition"
          >
            Partner / Admin Login
          </button>
        </div>
